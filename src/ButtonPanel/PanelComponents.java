...
public class PanelComponents {  
    ...
    public void newPanel(Container pane) {
        ...
        cSUBMIT.addActionListener((ActionEvent e) -> {
            Thread qThread;
            qThread = new Thread() {
                @Override
                public void run() {
        ...
        browseButton.addActionListener((ActionEvent ev) -> {
    ...
    public void newPanelDoubleImage(Container pane) {
        ...
        browseButton1.addActionListener((ActionEvent ev) -> {
            logger.getLogger().log(Level.INFO, "User is searching for file");
        ...
        browseButton2.addActionListener((ActionEvent ev) -> {
            logger.getLogger().log(Level.INFO, "User is searching for file");
