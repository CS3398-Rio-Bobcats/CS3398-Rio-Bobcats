...
//    JPanel mainPanel = new JPanel(new BorderLayout());
        ...
        // add set properties of label and add to JPanel
        ...
        introText.setHorizontalAlignment(SwingConstants.LEADING);
        ...
        hideText.addActionListener((ActionEvent ev) -> {
        ...
        hideImage.addActionListener((ActionEvent ev) -> {
        ...
        revealText.addActionListener((ActionEvent ev) -> {
        ...
        revealImage.addActionListener((ActionEvent ev) -> {
        ...
        convertImage.addActionListener((ActionEvent ev) -> {
